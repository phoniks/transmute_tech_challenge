...
var ReadableStream = /*#__PURE__*/function () {
   ...
   */
  ReadableStream.readAll = function readAll(stream) {
    try {
      ...
      var readBody = new Promise(function (resolve, reject) {
        stream.on('end', resolve);
        stream.on('error', reject);
      }); // Wait until the read is completed.

      return Promise.resolve(readBody).then(function () {
        return content;
      });
    } catch (e) {
...
export { AbstractVersionMetadata, AnchoredDataSerializer, CoreErrorCode, Encoder, ErrorCode, FetchResultCode$1 as FetchResultCode, JsonCanonicalizer, Multihash, OperationType$1 as OperationType, PublicKeyPurpose$1 as PublicKeyPurpose, ReadableStream, ResponseStatus$1 as ResponseStatus, SharedErrorCode, SidetreeError, SortedArray, TransactionProcessingStatus$1 as TransactionProcessingStatus, protocolParameters };
