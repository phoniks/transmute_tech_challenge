...
import { FetchResultCode, SidetreeError, ErrorCode, OperationType } from '@sidetree/common';
import { PrimaryColumn, ObjectIdColumn, Column, Entity, createConnection } from 'typeorm';
  ...
  MongoDb.isServerAvailable = function isServerAvailable(serverUrl) {
    try {
      ...
      var _temp2 = _catch(function () {
        return Promise.resolve(MongoClient.connect(serverUrl, {
...
var MongoDbBase = /*#__PURE__*/function () {
  ...
  _proto.initialize = function initialize() {
    try {
      ...
      return Promise.resolve(_this5$client2 ? _temp2(_this5$client2) : Promise.resolve(MongoClient.connect(_this6.serverUrl, {
        useUnifiedTopology: true,
        useNewUrlParser: true
      })).then(_temp2));
    } catch (e) {
    ...
    try {
      ...
      var _temp2 = _catch(function () {
        ...
        if (transactionNumber === undefined) {
          ...
          dbCursor = _this9.collection.find({
            transactionNumber: {
              $gt: Long.fromNumber(transactionNumber)
            }
          });
...
__decorate([PrimaryColumn(), ObjectIdColumn(), __metadata("design:type", String)], Operation.prototype, "_id", void 0);

__decorate([Column(), __metadata("design:type", String)], Operation.prototype, "didUniqueSuffix", void 0);

__decorate([Column(), __metadata("design:type", String)], Operation.prototype, "type", void 0);

__decorate([Column(), __metadata("design:type", Buffer)], Operation.prototype, "operationBuffer", void 0);

__decorate([Column(), __metadata("design:type", Number)], Operation.prototype, "transactionTime", void 0);

__decorate([Column(), __metadata("design:type", Number)], Operation.prototype, "transactionNumber", void 0);

__decorate([Column(), __metadata("design:type", Number)], Operation.prototype, "operationIndex", void 0);

Operation = /*#__PURE__*/__decorate([/*#__PURE__*/Entity(), /*#__PURE__*/__metadata("design:paramtypes", [String, String, Buffer, Number, Number, Number])], Operation);
...
export { MongoDb, MongoDbCasCache, MongoDbOperationQueue, MongoDbTransactionStore, MongoDbUnresolvableTransactionStore, OperationStore };
//# sourceMappingURL=db.esm.js.map
