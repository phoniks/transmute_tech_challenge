...
import { VersionManager, DownloadManager, Resolver, BatchScheduler, Observer, ServiceInfo } from '@sidetree/core';
import { IpfsCasWithCache } from '@sidetree/cas';
import { OperationStore, MongoDbTransactionStore, MongoDbUnresolvableTransactionStore } from '@sidetree/db';
...
var DidMethod = /*#__PURE__*/function () {
  function DidMethod(config, protocolVersions, blockchain) {
    ...
    this.operationStore = new OperationStore(config.mongoDbConnectionString, config.databaseName);
    this.blockchain = blockchain;
    this.cas = new IpfsCasWithCache(config.contentAddressableStoreServiceUri, config.mongoDbConnectionString, config.databaseName);
    ...
    this.observer = new Observer(this.versionManager, this.blockchain, config.maxConcurrentDownloads, this.operationStore, this.transactionStore, this.unresolvableTransactionStore, config.observingIntervalInSeconds);
...
export { DidMethod };
//# sourceMappingURL=did-method.esm.js.map
