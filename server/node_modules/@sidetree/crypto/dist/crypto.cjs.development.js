...
var toKeyPair = function toKeyPair(mnemonic, index, type) {
  ...
  try {
    return Promise.resolve(bip39.mnemonicToSeed(mnemonic)).then(function (seed) {
      ...
      var _temp = _switch(type, [[function () {
        ...
        {
          return Promise.resolve(didKeySecp256k1.Secp256k1KeyPair.generate({
        ...
        {
          return Promise.resolve(didKeyEd25519.Ed25519KeyPair.generate({
            secureRandom: function secureRandom() {
              return addrNode._privateKey;
            }
...
var createSigner = function createSigner(privateKeyJwk) {
  try {
    ...
    var _temp4 = _switch(privateKeyJwk.crv, [[function () {
      ...
      {
        return Promise.resolve(didKeyEd25519.Ed25519KeyPair.from({
      ...
      {
        return Promise.resolve(didKeySecp256k1.Secp256k1KeyPair.from({
          publicKeyJwk: privateKeyJwk,
          privateKeyJwk: privateKeyJwk
...
exports.ed25519 = didKeyEd25519;
exports.secp256k1 = didKeySecp256k1;
exports.createJwsSigner = createJwsSigner;
exports.createJwsVerifier = createJwsVerifier;
exports.generateMnemonic = generateMnemonic;
exports.toKeyPair = toKeyPair;
//# sourceMappingURL=crypto.cjs.development.js.map
