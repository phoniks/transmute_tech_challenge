...
var multihashes = _interopDefault(require('multihashes'));
...
var eventLogToSidetreeTransaction = function eventLogToSidetreeTransaction(log) {
  ...
  var anchorString = common.AnchoredDataSerializer.serialize(anchoredData);
  return {
    ...
    this.write = function (anchorString, _fee) {
      ...
      try {
        return Promise.resolve(utils.getAccounts(_this3.web3)).then(function (_ref) {
          ...
          var _AnchoredDataSerializ = common.AnchoredDataSerializer.deserialize(anchorString),
...
exports.EthereumLedger = EthereumLedger;
//# sourceMappingURL=ethereum.cjs.development.js.map
