...
var IpfsCasWithCache = /*#__PURE__*/function (_IpfsCas) {
  ...
  function IpfsCasWithCache(casUrl, dbUrl, dbName) {
    ...
    _this.cache = new MongoDbCasCache(dbUrl, dbName);
    return _this;
  }
...
var MockCas = /*#__PURE__*/function () {
  ...
  MockCas.getAddress = function getAddress(content) {
    try {
      ...
      var dagNode = new DAGNode(marshaled);
...
export { CasIpfs as IpfsCas, IpfsCasWithCache, MockCas };
//# sourceMappingURL=cas.esm.js.map
