...
export declare function shimCompilations(inputCompilations: CompilerCompilation[], shimmedCompilationIdPrefix?: string): Compilation[];
/**
 ...
 */
export declare function shimArtifacts(artifacts: (Artifact | CompiledContract)[], files?: string[], shimmedCompilationId?: string): Compilation[];
/**
 ...
 */
export declare function shimContracts(artifacts: (Artifact | CompiledContract)[], files?: string[], shimmedCompilationId?: string): Compilation;
