...
var didKeyCipher = require('@transmute/did-key-cipher');
...
exports.X25519KeyPair = X25519KeyPair_1 = /*#__PURE__*/function () {
  ...
  X25519KeyPair.generateEphemeralKeyPair = function generateEphemeralKeyPair() {
    try {
      return Promise.resolve(didKeyCipher.getEpkGenerator(X25519KeyPair_1, {
  ...
  X25519KeyPair.kekFromEphemeralPeer = function kekFromEphemeralPeer(_ref) {
    ...
    try {
      ...
      return Promise.resolve(keyAgreementKey.deriveSecret({
        ...
        return Promise.resolve(didKeyCipher.deriveKey({
          secret: secret,
          producerInfo: producerInfo,
          consumerInfo: consumerInfo
        })).then(function (keyData) {
          return Promise.resolve(didKeyCipher.KeyEncryptionKey.createKek({
            keyData: keyData
  ...
  X25519KeyPair.fromEdKeyPair = function fromEdKeyPair(ed25519KeyPair) {
    ...
    if (ed25519KeyPair.publicKeyBase58) {
      publicKeyBase58 = bs58.encode(ed25519.convertPublicKeyToX25519(bs58.decode(ed25519KeyPair.publicKeyBase58)));
    }

    if (ed25519KeyPair.privateKeyBase58) {
      privateKeyBase58 = bs58.encode(ed25519.convertSecretKeyToX25519(bs58.decode(ed25519KeyPair.privateKeyBase58)));
    }
  ...
  _proto.deriveSecret = function deriveSecret(options) {
    ...
    var scalarMultipleResult = x25519.sharedKey(new Uint8Array(privateKeyBytes), new Uint8Array(remotePubkeyBytes), true);
...
exports.X25519KeyPair.JWE_ALG = 'ECDH-ES+A256KW';
exports.X25519KeyPair = X25519KeyPair_1 = /*#__PURE__*/tslib.__decorate([/*#__PURE__*/common.types.staticImplements()], exports.X25519KeyPair);

var resolve = /*#__PURE__*/common.getResolve(exports.X25519KeyPair);
...
//# sourceMappingURL=did-key-x25519.cjs.development.js.map
