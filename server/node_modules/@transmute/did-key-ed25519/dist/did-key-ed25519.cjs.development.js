...
var sign = function sign(payload, privateKeyJwk, header) {
  ...
  var signature = ed25519.sign(secretKey, message);
...
var verify = function verify(jws, publicKeyJwk) {
  ...
  var message = new Uint8Array(Buffer.from(encodedHeader + "." + encodedPayload));
  var verified = ed25519.verify(publicKey, message, new Uint8Array(base64url.toBuffer(encodedSignature)));
...
exports.Ed25519KeyPair = Ed25519KeyPair_1 = /*#__PURE__*/function () {
  ...
  _proto.toX25519KeyPair = function toX25519KeyPair(exportPrivateKey) {
    ...
    if (exportPrivateKey) {
      return didKeyX25519.X25519KeyPair.fromEdKeyPair({
  ...
  _proto.signer = function signer() {
    ...
    return {
      sign: function sign(_ref2) {
        ...
        try {
          var signatureUInt8Array = ed25519.sign(privateKeyBuffer, data);
...
exports.Ed25519KeyPair = Ed25519KeyPair_1 = /*#__PURE__*/tslib.__decorate([/*#__PURE__*/common.types.staticImplements()], exports.Ed25519KeyPair);

var resolve = /*#__PURE__*/common.getResolve(exports.Ed25519KeyPair);
...
//# sourceMappingURL=did-key-ed25519.cjs.development.js.map
