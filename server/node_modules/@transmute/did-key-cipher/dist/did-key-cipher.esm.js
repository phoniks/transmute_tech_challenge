...
import { XChaCha20Poly1305, KEY_LENGTH as KEY_LENGTH$1 } from '@stablelib/xchacha20poly1305';
...
var decrypt = function decrypt(_ref2) {
  ...
  try {
    ...
    var cipher = new XChaCha20Poly1305(cek);
...
var encrypt = function encrypt(_ref) {
  ...
  try {
    ...
    var cipher = new XChaCha20Poly1305(cek); // Note: Uses a random value here as a counter is not viable -- multiple
...
var generateKey = function generateKey() {
  try {
    ...
    return Promise.resolve(crypto$1.getRandomValues(new Uint8Array(KEY_LENGTH$1)));
  } catch (e) {
    return Promise.reject(e);
  }
};
...
export { Cipher, KeyEncryptionKey, deriveKey, getEpkGenerator };
//# sourceMappingURL=did-key-cipher.esm.js.map
